...
public class EdgeCreatorCppOSM implements EdgeCreator<NodeCppOSM, EdgeCppOSM> {
    public EdgeCppOSM create(final NodeCppOSM node1, final NodeCppOSM node2, final int weight) {
        return new EdgeCppOSM(node1, node2, weight, null);
    }
	
	public EdgeCppOSM create(NodeCppOSM node1, NodeCppOSM node2, int weight, WayOSM metadata) {
