...
public class GraphCompleteTest { // TODO this is not the right class for all of this tests. was initially my fault :/ -tbach
    ...
    @Test
    public void ShortetstPathWithWeightsTEST() {
        ...
        node1.getEdgeToNode(node5).setWeight(100.0);
        
        final ArrayList<NodeCpp> pathList = graph.getAlgorithms().getshortestPath(node0, node8);
