...
public class OsmImporterTest {
	...
	public void testImportOsmUndirected(){
		GraphUndirected<NodeCppOSM, EdgeCppOSM> graph = importOsmUndirected(getClass().getResource("../zweibruecken_way_no_meta.osm").toString());
	...
	public void testImportLine(){
		...
		GraphUndirected<NodeCppOSM, EdgeCppOSM> graph = importOsmUndirected(getClass().getResource("../testLine.osm").toString());
		...
		NodeCppOSM node1 = graph.getNode(260070555l);
		EdgeCppOSM edge1 = node1.getEdges().get(0);
	...
	public void testImportCircle(){
		//GraphUndirected graph = testImporter.importOsmUndirected("zweibruecken_way_no_meta.osm");
		GraphUndirected<NodeCppOSM, EdgeCppOSM> graph = importOsmUndirected(getClass().getResource("../testCircle.osm").toString());
